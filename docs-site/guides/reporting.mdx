---
title: Reporting
description: Report, dashboard, serve, compare, sweep, and matrix commands for analyzing simulation results.
---
...
The sweep report includes percentile analysis to identify central tendency, tail risk, and variability.
