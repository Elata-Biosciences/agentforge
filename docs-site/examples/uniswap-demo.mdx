---
title: Uniswap v4 AgentForge Demo
description: Agent-based simulation of Uniswap v4 pool mechanisms with deterministic and LLM-driven agent strategies.
---

Agent-based simulation of Uniswap v4 pool mechanisms using AgentForge. This demo demonstrates how to integrate AgentForge into an existing protocol repository with both deterministic and LLM-driven agent strategies.
...
- [Core Concepts](/guides/concepts) — Scenarios, agents, ticks, packs
- [LLM/Gossip Workflow](/guides/llm-gossip-replay) — Exploration, replay, and gossip channels
- [AgentForge GitHub](https://github.com/Elata-Biosciences/agentforge) — Framework docs and API reference
